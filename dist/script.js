...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.colored .video .play', '.overlay').init();
...
function () {
  ...
  _createClass(Download, [{
    ...
    value: function downloadItem(path) {
      ...
      document.body.appendChild(link); //чтобы событие вызвалось само на ссылке:
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function init() {
      if (this.btns.length > 0) {
        var tag = document.createElement('script'); //подключение youtube-player к странице:
    ...
    value: function showContent() {
      this.triggers.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          if (!sibling.classList.contains('showAccordionContent')) {
            sibling.classList.add('showAccordionContent');
            ...
            sibling.classList.remove('showAccordionContent');
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    key: "filterSlides",
    value: function filterSlides(slides) {
    ...
    value: function decorizeSlides() {
      ...
      this.filterSlides(this.slides).forEach(function (item) {
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        var active = _this2.filterSlides(_this2.slides)[_this2.filterSlides(_this2.slides).length - 1];

        _this2.container.insertBefore(active, _this2.filterSlides(_this2.slides)[0]);
    ...
    value: function init() {
      ...
      try {
        if (this.autoplay) {
          ...
          [this.prev, this.next, this.filterSlides(this.slides)[0].parentElement].forEach(function (item) {
            item.addEventListener('mouseenter', function () {
              clearInterval(_this4.pause);
            });
            item.addEventListener('mouseleave', function () {
              _this4.activateAutoplay();
            });
          });
        }
